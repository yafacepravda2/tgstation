/obj/item/bong
	...
	icon = 'shitcode/face/icons/obj/bong.dmi'
	lefthand_file = 'shitcode/face/icons/obj/mob/lefthand.dmi'
	righthand_file = 'shitcode/face/icons/obj/mob/righthand.dmi'
	icon_state = "bongoff"
...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('shitcode/face/sounds/misc/lungbust_moan1.ogg','shitcode/face/sounds/misc/lungbust_moan2.ogg', 'shitcode/face/sounds/misc/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('shitcode/face/sounds/misc/lungbust_cough1.ogg','shitcode/face/sounds/misc/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
...
/obj/item/cigarette/pipe/crackpipe
	...
	worn_icon = 'shitcode/face/icons/obj/mob/mask.dmi'
